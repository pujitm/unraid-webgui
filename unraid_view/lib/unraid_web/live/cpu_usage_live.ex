defmodule UnraidWeb.CpuUsageLive do
  @moduledoc """
  ...
  def mount(_params, _session, socket) do
    if connected?(socket), do: Unraid.Monitoring.CPU.subscribe()

    cores = Unraid.Monitoring.CPU.per_core_usage()
    util = Unraid.Monitoring.CPU.average_util(cores)
    history = [util]
  ...
  # Internal helpers were moved to `Unraid.Monitoring.CPU`.
end
