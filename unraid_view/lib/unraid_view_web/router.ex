defmodule UnraidViewWeb.Router do
  use UnraidViewWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {UnraidViewWeb.Layouts, :root}
  ...
  if Application.compile_env(:unraid_view, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: UnraidViewWeb.Telemetry
